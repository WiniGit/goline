class PopupDA {
    ...
    static get_popupImage(type) {
        switch (type) {
            case "info":
                return 'https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/popup-img/info.svg'
            case "error":
                return 'https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/popup-img/error.svg'
            case "warning":
                return 'https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/popup-img/warning.svg'
            case "success":
                return 'https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/popup-img/success.svg'
            default:
                return 'https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/popup-img/info.svg'
        }
    }
