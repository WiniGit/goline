class ProjectDA {
    ...
    static initLayoutResponsive() {
        fetch("https://cdn.jsdelivr.net/gh/WiniGit/goline@4e3b6c3/css/css_Responsive.txt")
    ...
    static create_UI_Project(item) {
        ...
        if (HomeDA.sort_project == 1) {
            pro =
                ...
                '            <img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@4e3b6c3/lib/assets/pen.svg" class="box32">' +
                '                <div class="col">' +
