class ProjectDA {
  ...
  static initLayoutResponsive() {
    fetch("https://cdn.jsdelivr.net/gh/WiniGit/goline@785f3a1/css/css_Responsive.txt").then((response) =>
