class ProjectDA {
  ...
  static initLayoutResponsive() {
    fetch("https://cdn.jsdelivr.net/gh/WiniGit/goline@c6fbab0/css/css_Responsive.txt").then((response) =>
