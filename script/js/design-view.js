...
function createEditAlign() {
  ...
  let listAlignItem = [
    {
      scr: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/layout_align_left.svg",
      onclick: function () {
    ...
    {
      scr: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/layout_align_horizontal_center.svg",
      onclick: function () {
    ...
    {
      scr: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/layout_align_right.svg",
      onclick: function () {
    ...
    {
      scr: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/layout_align_top.svg",
      onclick: function () {
    ...
    {
      scr: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/layout_align_vertical_center.svg",
      onclick: function () {
    ...
    {
      scr: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/layout_align_bottom.svg",
      onclick: function () {
  ...
  icon_extend.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/extend_align.svg";
...
function createEditSizePosition() {
  ...
  if (selected_list.every((e) => EnumCate.extend_frame.some((cate) => e.CateID === cate))) {
    ...
    if (selected_list.every((e) => !e.WAutolayoutItem)) {
      ...
      btn_vertical.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/frame_vertical.svg";
      ...
      btn_horizontal.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/frame_horizontal.svg";
    ...
    if (selected_list.every((e) => !e.WAutolayoutItem)) {
      ...
      icon_resize_to_fit.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/resize_to_fit.svg";
  ...
  icon_ratioWH.src = `https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isRatio ? "ratioWH" : "un_ratioWH"}.svg`;
  icon_ratioWH.className = "img-button size-28 tlwh-option";
  if (!isRatio) {
    icon_ratioWH.onclick = function () {
      isRatio = !isRatio;
      if (isRatio) {
        this.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/ratioWH.svg";
        this.style.borderColor = "transparent";
      } else {
        this.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/un_ratioWH.svg";
  ...
  if (selected_list.every((e) => e.CateID !== EnumCate.table)) {
    ...
    // input edit rotate
    let edit_rotate = _textField("82px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/rotate_rect.svg", undefined, "0");
    ...
    if (list_seleted_radius.length > 0) {
      ...
      let edit_radius = _textField("82px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/radius_rect.svg", undefined, list_radius_value.length == 1 ? list_radius_value[0] : "Mixed");
      ...
      icon_radius_detail.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/radius_detail.svg";
      ...
      icon_HTML.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/radius_rect.svg";
...
function createAutoLayout() {
  ...
  if (showDetails) {
    ...
    if (!isEditTable) {
      let input_child_space = _textField("88px", `https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "vertical" : "horizontal"} child spacing.svg`, undefined, childSpaceValues.length == 1 ? childSpaceValues[0] : "Mixed");
      ...
      if (autoLayoutList.every((wbaseItem) => EnumCate.extend_frame.some((cate) => wbaseItem.CateID === cate))) {
        ...
        let inputRunSpace = _textField("88px", `https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "horizontal" : "vertical"} child spacing.svg`, undefined, runSpaceValues.length == 1 ? runSpaceValues[0] : "Mixed");
    ...
    let input_padding_horizontal = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding horizontal.svg", undefined, padLeftValue == padRightValue ? padLeftValue : "Mixed");
    ...
    let input_padding_vertical = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding vertical.svg", undefined, padTopValue == padBotValue ? padTopValue : "Mixed");
    ...
    let input_padding_left = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding left.svg", undefined, padLeftValue);
    ...
    let input_padding_top = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding top.svg", undefined, padTopValue);
    ...
    icon_padding_details.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding details.svg";
    let input_padding_right = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding right.svg", undefined, padRightValue);
    ...
    let input_padding_bottom = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/padding bottom.svg", undefined, padBotValue);
...
function _alignTable(isVertical = true, value) {
  ...
  let top_left = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "left vertical" : "top horizontal"}.svg`);
  top_left.id = AlignmentType.top_left;
  top_left.style.top = "0";
  top_left.style.left = "0";
  let top_center = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "center vertical" : "top horizontal"}.svg`);
  ...
  let top_right = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "right vertical" : "top horizontal"}.svg`);
  top_right.id = AlignmentType.top_right;
  top_right.style.top = "0";
  top_right.style.right = "0";
  let left_center = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "left vertical" : "center horizontal"}.svg`);
  ...
  let center = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "center vertical" : "center horizontal"}.svg`);
  center.id = AlignmentType.center;
  center.style.left = "50%";
  center.style.top = "50%";
  center.style.transform = "translate(-50%, -50%)";
  let right_center = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "right vertical" : "center horizontal"}.svg`);
  ...
  let bottom_left = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "left vertical" : "bottom horizontal"}.svg`);
  bottom_left.id = AlignmentType.bottom_left;
  bottom_left.style.left = "0";
  bottom_left.style.bottom = "0";
  let bottom_center = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "center vertical" : "bottom horizontal"}.svg`);
  ...
  let bottom_right = _btnAlignType(`https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/${isVertical ? "right vertical" : "bottom horizontal"}.svg`);
...
function createEditBackground() {
  ...
  if (isBgImg) {
    ...
    btnEye.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/eye-outline.svg";
  ...
  let btnSelectSkin = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/buttonStyle.svg", null, function () {
...
function createEditTextStyle() {
  ...
  if (listTypoSkin.length == 1 && listTypoSkin[0] && listTextStyle.filterAndMap((wbaseItem) => wbaseItem.StyleItem.TextStyleID).length == 1) {
    ...
    if (listTextStyle.some((e) => e.CateID !== EnumCate.chart)) {
      ...
      let input_line_height = _textField("100%", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/line-height.svg", undefined, lineHeightValues.length == 1 ? (lineHeightValues[0] == null ? "Auto" : lineHeightValues[0]) : "Mixed", "25px");
      ...
      let input_letter_spacing = _textField("100%", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/letter-spacing.svg", undefined, lSpacingValues.length == 1 ? lSpacingValues[0] : "Mixed", "28px");
      ...
      [
        {
          ...
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/auto-width.svg",
        },
        {
          attribute: TextAutoSize.autoHeight,
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/auto-height.svg",
        },
        {
          attribute: TextAutoSize.fixedSize,
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/fixed-size.svg",
        },
      ],
      function (value) {
      ...
      [
        {
          ...
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/text-align-left.svg",
        },
        {
          attribute: TextAlign.center,
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/text-align-center.svg",
        },
        {
          attribute: TextAlign.right,
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/text-align-right.svg",
        },
      ],
      function (value) {
      ...
      [
        {
          ...
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/text-align-vertical-top.svg",
        },
        {
          attribute: TextAlignVertical.middle,
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/text-align-vertical-center.svg",
        },
        {
          attribute: TextAlignVertical.bottom,
          src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/text-align-vertical-bottom.svg",
        },
      ],
      function (value) {
...
function _btnDropDownSelect(list = [], func_on_show_popup, onclick) {
  ...
  icon_down.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/down_black.svg";
...
function createEditBorder() {
  ...
  if (listBorderSkin.length == 1 && listBorderSkin[0] && listBorder.filterAndMap((wbaseItem) => wbaseItem.StyleItem.DecorationItem.BorderID).length == 1) {
    ...
    if (listBorder.some((wbaseItem) => !wbaseItem.StyleItem.DecorationItem.BorderItem)) {
      ...
      let edit_stroke_width = _textField("60px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/stroke-width.svg", undefined, widthValues.length == 1 ? widthValues[0] : "Mixed", "28px");
      ...
      let btnSelectBorderSide = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-all-black.svg", null, function () {
      ...
      let edit_line_action2 = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/more-horizontal.svg", null, function () {});
      ...
      let input_border_left = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-left-black.svg", undefined, "0", "36px");
      ...
      var input_border_top = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-top-black.svg", undefined, "0", "36px");
      ...
      var input_border_right = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-right-black.svg", undefined, "0", "36px");
      ...
      var input_border_bottom = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-bottom-black.svg", undefined, "0", "36px");
      ...
      if (firstSideValue == BorderSide.custom) {
        ...
        btnSelectBorderSide.firstChild.src = `https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-all-black.svg`;
        ...
        btnSelectBorderSide.firstChild.src = `https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-${firstSideValue.toLowerCase()}-black.svg`;
      }
    }
  }
  return editContainer;
...
function createEditEffect() {
  ...
  if (listEffectSkin.length == 1 && listEffectSkin[0] && listEffect.filterAndMap((wbaseItem) => wbaseItem.StyleItem.DecorationItem.EffectID).length == 1) {
    ...
    if (listEffect.every((wbaseItem) => !wbaseItem.StyleItem.DecorationItem.EffectItem)) {
      ...
      let effect_setting = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/effect-settings.svg", null, function () {
        setTimeout(function () {
      ...
      let btn_isShow = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/eye-outline.svg", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/eye-close.svg", function () {});
      btn_isShow.className = "action-button";
      div_select_eType.appendChild(btn_isShow);

      let btn_delete = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/minus.svg", null, function () {
        deleteEffect();
        updateUIEffect();
      });
...
function createEditColorForm(funcEdit, funcSubmit, funcDelete) {
  ...
  buttonVisibleIcon.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/eye-outline.svg";
  ...
  if (funcDelete) {
    ...
    buttonMinusIcon.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/minus.svg";
  ...
  buttonVisible.onclick = function () {
    ...
    buttonVisibleIcon.src = !visible ? "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/eye-close.svg" : "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/eye-outline.svg";
  };
  // UI action
...
function selectBorderSide(params, onclick) {
  let list = [
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-all-white.svg",
      name: "Mixed",
    },
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-all-white.svg",
    ...
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-top.svg",
      name: BorderSide.top,
    },
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-left.svg",
      name: BorderSide.left,
    },
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-bottom.svg",
      name: BorderSide.bottom,
    },
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-right.svg",
      name: BorderSide.right,
    },
    {
      src: "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/settings-gear.svg",
  ...
  for (let i = 0; i < list.length; i++) {
    ...
    checkIcon.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/check.svg";
...
function createDropdownTableSkin(enumCate, offset, currentSkinID) {
  ...
  title.style.flex = 1;
  let action1 = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/library-black.svg", null, function () {});

  header.appendChild(title);
  header.appendChild(action1);
  let action2 = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/add2.svg", null, function () {
    setTimeout(function () {
...
function createSkinTileHTML(enumCate, jsonSkin) {
  ...
  switch (enumCate) {
    ...
    case EnumCate.effect:
      ...
      demo_effect.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/effect-settings.svg";
...
function popupEditSkin(enumCate, jsonSkin) {
  ...
  switch (enumCate) {
    ...
    case EnumCate.typography:
      ...
      // input line-height
      let input_line_height = _textField("100%", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/line-height.svg", undefined, "0", "25px");
      input_line_height.style.flex = 1;
      input_line_height.style.marginRight = "8px";
      ...
      div_height_spacing.appendChild(input_line_height);
      // input letter spacing
      let input_letter_spacing = _textField("100%", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/letter-spacing.svg", undefined, "0", "28px");
    ...
    case EnumCate.border:
      ...
      let edit_stroke_width = _textField("60px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/stroke-width.svg", undefined, "0", "28px");
      ...
      group_custom_border_side.appendChild(input_border_left);
      let input_border_top = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-top-black.svg", undefined, "0", "36px");
      ...
      group_custom_border_side.appendChild(input_border_top);
      let input_border_right = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-right-black.svg", undefined, "0", "36px");
      input_border_right.style.marginLeft = "8px";
      ...
      group_custom_border_side.appendChild(input_border_right);
      let input_border_bottom = _textField("88px", "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/border-bottom-black.svg", undefined, "0", "36px");
...
function wbaseSkinTile(enumCate, onclick, onRemove) {
  ...
  btn_unLink.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/unlink-skin.svg";
  switch (enumCate) {
    case EnumCate.color:
      let demo_color = document.createElement("div");
      demo_color.style.width = "15px";
  ...
  if (onRemove) {
    ...
    btn_remove_color.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/minus.svg";
...
function createSelectionSkins() {
  ...
  let btnSelectSkin = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/read.svg", null, StyleDA.getListMergeSkin);
  header.appendChild(btnSelectSkin);
...
function mergeSkinTile(enumCate, jsonSkin) {
  ...
  switch (enumCate) {
    ...
    case EnumCate.effect:
      var demoDiv1 = document.createElement("div");
      demoDiv1.className = "demo-div";
      demoDiv1.style.backgroundImage = `url(${"https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/effect-settings.svg"})`;
...
function createBreakpoint() {
  ...
  let btnSelectSkin = createButtonAction("https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/filter.svg", null, function () {
...
function winiResponsive() {
  ...
  prefixIcon.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/column.svg";
...
function selectionClass() {
  ...
  body.replaceChildren(
    ...listStyleClass.map((clName) => {
      ...
      targetImg.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@7925dd0/lib/assets/target.svg";
