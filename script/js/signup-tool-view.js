{
    ...
    $(".signup-input-visible").on("click", function () {
        ...
        $('.signup-input-visible-img').attr('src', signupPass ? "/lib/assets/eye-invisible.svg" : "/lib/assets/eye-visible.svg");
    ...
    $(".signup-re-input-visible").on("click", function () {
        ...
        $('.signup-re-input-visible-img').attr('src', signupRePass ? "/lib/assets/eye-invisible.svg" : "/lib/assets/eye-visible.svg");
    ...
    $("body").on('click', '.login-input-visible', function () {
        loginPass = !loginPass;
        $(this).parent().find('.login-input-visible-img').attr('src', loginPass ? "/lib/assets/eye-invisible.svg" : "/lib/assets/eye-visible.svg");
