{
    ...
    $(".signup-input-visible").on("click", function () {
        ...
        $('.signup-input-visible-img').attr('src', signupPass ? "https://cdn.jsdelivr.net/gh/WiniGit/goline@f7ad6db/lib/assets/eye-invisible.svg" : "https://cdn.jsdelivr.net/gh/WiniGit/goline@f7ad6db/lib/assets/eye-visible.svg");
    ...
    $(".signup-re-input-visible").on("click", function () {
        ...
        $('.signup-re-input-visible-img').attr('src', signupRePass ? "https://cdn.jsdelivr.net/gh/WiniGit/goline@f7ad6db/lib/assets/eye-invisible.svg" : "https://cdn.jsdelivr.net/gh/WiniGit/goline@f7ad6db/lib/assets/eye-visible.svg");
    ...
    $("body").on('click', '.login-input-visible', function () {
        loginPass = !loginPass;
        $(this).parent().find('.login-input-visible-img').attr('src', loginPass ? "https://cdn.jsdelivr.net/gh/WiniGit/goline@f7ad6db/lib/assets/eye-invisible.svg" : "https://cdn.jsdelivr.net/gh/WiniGit/goline@f7ad6db/lib/assets/eye-visible.svg");
