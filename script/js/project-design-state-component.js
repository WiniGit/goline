...
function create_UI_State() {
  ...
  function settingStateItem(stateItem) {
    return (
      ...
      // '               <button class="box24 select-skin-button button-transparent"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/buttonStyle.svg"></button>' +
      "           </div>" +
      ...
      "</div>" +
      "               </div>" +
      '               <button class="box24 abort-skin-button button-transparent hover-setting"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/unlink-skin.svg"></button>' +
      "           </div>" +
      "       </div>" +
      ...
      '           <div class="row field-value">' +
      '               <div class="row skin-container hover-setting">' +
      '                   <div class="box16"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/effect-settings.svg"></div>' +
      '                   <div class="skin-name regular1 text-body">' +
  ...
  switch (selected_list[0].CateID) {
    ...
    case EnumCate.table:
      ...
      inputRowNumber.onblur = function (e) {
        e.stopPropagation();
        if (!isNaN(parseInt(this.value)) && selected_list[0].TableRows && selected_list[0].TableRows.length !== parseInt(this.value) && parseInt(this.value) > 0) editJsonItem({ RowNumber: this.value });
...
function editColorContainer(color, func) {
  ...
  imgIcon.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/buttonStyle.svg";
