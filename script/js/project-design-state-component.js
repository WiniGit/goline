function create_stateContainer() {
  ...
  function create_UI_State() {
    ...
    function settingStateItem(stateItem) {
      return (
        ...
        // '               <button class="box24 select-skin-button button-transparent"><img src="/lib/assets/buttonStyle.svg"></button>' +
        "           </div>" +
        ...
        "</div>" +
        "               </div>" +
        '               <button class="box24 abort-skin-button button-transparent hover-setting"><img src="/lib/assets/unlink-skin.svg"></button>' +
        "           </div>" +
        "       </div>" +
        ...
        '           <div class="row field-value">' +
        '               <div class="row skin-container hover-setting">' +
        '                   <div class="box16"><img src="/lib/assets/effect-settings.svg"></div>' +
        '                   <div class="skin-name regular1 text-body">' +
  ...
  function editColorContainer(color, func) {
    ...
    imgIcon.src = "/lib/assets/buttonStyle.svg";
