function create_stateContainer() {
  ...
  function create_UI_State() {
    ...
    function settingStateItem(stateItem) {
      return (
        ...
        // '               <button class="box24 select-skin-button button-transparent"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@38cb2df/lib/assets/buttonStyle.svg"></button>' +
        "           </div>" +
        ...
        "</div>" +
        "               </div>" +
        '               <button class="box24 abort-skin-button button-transparent hover-setting"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@38cb2df/lib/assets/unlink-skin.svg"></button>' +
        "           </div>" +
        "       </div>" +
        ...
        '           <div class="row field-value">' +
        '               <div class="row skin-container hover-setting">' +
        '                   <div class="box16"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@38cb2df/lib/assets/effect-settings.svg"></div>' +
        '                   <div class="skin-name regular1 text-body">' +
  ...
  function editColorContainer(color, func) {
    ...
    imgIcon.src = "https://cdn.jsdelivr.net/gh/WiniGit/goline@38cb2df/lib/assets/buttonStyle.svg";
