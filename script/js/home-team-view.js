class TeamView {
    static create_teamNav(item) {
        let team_tile =
            ...
            '    <div class="box32 center"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/logo.svg" alt=""></div>' +
            ...
            for (let item of list) {
                list_project +=
                    `<div data-id=${item.ID} class="project-card center">
                        <div class="box100"><img src="https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/logo.svg" /></div>
