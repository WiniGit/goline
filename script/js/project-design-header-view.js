...
let list_tool = [
  {
    ...
    scr: 'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/move.svg'
  },
  {
    ...
    scr: 'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/frame.svg'
  },
  {
    ...
    scr: 'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/rectangle.svg'
  },
  {
    ...
    scr: 'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/base_component.svg'
  },
  {
    message: ToolState.text,
    scr: 'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/text.svg'
  },
  {
    message: ToolState.hand_tool,
    scr: 'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/hand.svg'
  }
]

let logo_wini = document.createElement('img')
logo_wini.src =
  'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/logo_wini.svg'
...
button_play_img.src =
  'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/play.svg'
...
history_img.src =
  'https://cdn.jsdelivr.net/gh/WiniGit/goline@fc5ed59/lib/assets/history.svg'
...
function customerList () {
  ...
  ProjectDA.obj.CustomerProjectItems.forEach(e => {
    ...
    if (
      PageDA.customerList.length === 0 ||
      PageDA.customerList.every(el => el.CustomerID !== e.CustomerID)
    ) {
