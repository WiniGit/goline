{
    ...
    $(".login-input-visible").click(function () {
        loginPass = !loginPass;
        $('.login-input-visible-img').attr('src', loginPass ? "https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/eye-invisible.svg" : "https://cdn.jsdelivr.net/gh/WiniGit/goline@4ff51a0/lib/assets/eye-visible.svg");
