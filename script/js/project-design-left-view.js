    ...
    searchBody.replaceChildren(
      ...filterList.reverse().map((wb) => {
        ...
        if (wb.IsWini && wb.CateID != EnumCate.tool_variant) {
          cateImg.src = "/lib/assets/component.svg";
        } else {
          switch (wb.CateID) {
            case EnumCate.tool_frame:
              cateImg.src = "/lib/assets/frame_black.svg";
              break;
            case EnumCate.tool_rectangle:
              cateImg.src = "/lib/assets/rectangle_black.svg";
              break;
            case EnumCate.tool_text:
              cateImg.src = "/lib/assets/text_black.svg";
              break;
            case EnumCate.tool_variant:
              cateImg.src = "/lib/assets/multiple_component.svg";
              break;
            default:
              cateImg.src = "/lib/assets/base_component_black.svg";
              break;
          }
        }
...
function createLayerTile(wbaseItem, isShowChildren = false) {
  ...
  if (wbaseItem.IsWini && wbaseItem.CateID != EnumCate.tool_variant) {
    icon_wbase.src = "/lib/assets/component.svg";
  } else {
    switch (wbaseItem.CateID) {
      case EnumCate.tool_frame:
        icon_wbase.src = "/lib/assets/frame_black.svg";
        break;
      case EnumCate.tool_rectangle:
        icon_wbase.src = "/lib/assets/rectangle_black.svg";
        break;
      case EnumCate.tool_text:
        icon_wbase.src = "/lib/assets/text_black.svg";
        break;
      case EnumCate.tool_variant:
        icon_wbase.src = "/lib/assets/multiple_component.svg";
        break;
      default:
        icon_wbase.src = "/lib/assets/base_component_black.svg";
        break;
    }
  }
