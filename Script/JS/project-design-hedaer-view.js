...
for (let i = 0; i < list_cate.length; i++) {
    ...
    switch (list_cate[i]) {
        ...
        case EnumCate.effect:
            ...
            demo_skin.className = "box20";
            demo_skin.src = "/lib/assets/effect-settings.svg";
            break;
        default:
            break;
    }
...
let list_tool = [
    {
        ...
        scr: "/lib/assets/move.svg",
    },
    {
        message: ToolState.hand_tool,
        scr: "/lib/assets/hand.svg",
    },
];

let logo_wini = document.createElement("img");
logo_wini.src = "/lib/assets/logo_wini.svg";
...
button_play.src = "/lib/assets/play.svg";
    ...
    if (PageDA.enableEdit) {
        list_tool.splice(1, 0, ...[
            ...
            },
            {
                ...
                scr: "/lib/assets/base_component.svg",
            },
            {
                message: ToolState.text,
                scr: "/lib/assets/text.svg",
            }
        ]);
    } else {
